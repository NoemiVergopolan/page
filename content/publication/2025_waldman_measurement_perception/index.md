...
#- name: Custom Link
#  url: 
url_pdf: https://doi.org/10.1088/1748-9326/adeff3
url_code: 
url_dataset: 
url_poster: 
url_project: 
...
# Featured image
image:
  caption: "Farmer-reported vs GPS measured field area and farmer-reported vs crop cut estimated yield (harvest). Dotted lines represent the median values for each distribution"
  focal_point: ""
  preview_only: false
