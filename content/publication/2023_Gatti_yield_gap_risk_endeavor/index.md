...
summary: "While potential maize yields in Zambia are 9 t per hectare (t/ha), the average farmer produces only 1–2. We evaluate the contribution of responses to weather risk to that gap by decomposing the yield gap in maize in Zambia. Risk aversion explained 24% of the average gap, varying widely by location, implying 6.75 tons per hectare attainable without added risk against 8.84 when maximizing profit."
tags:
- Agriculture
- Yield
- Risk
